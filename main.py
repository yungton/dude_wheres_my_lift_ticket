...
mountain = 'Jackson Hole Mountain'  # TODO: Make dynamic
...
try:
    ...
    while desired_date_reserved is False:
        ...
        if desired_date_reserved:
            # Commenting out the Twilio messaging for now. Probably will use email here instead since it's free
            # TODO Switch this below to emiail!
        ...
        print("Didn't reserve date. Retrying")
